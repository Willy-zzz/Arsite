...
const marcas = [
    ...
    {
        id: 11,
        name: 'Aruba EdgeConnect (Silver Peak)',
        description: 'Silver Peak, ahora integrado en Hewlett Packard Enterprise a través de Aruba Networking, es una solución líder en tecnología SD-WAN conocida actualmente como Aruba EdgeConnect. Permite a las empresas conectar sucursales, centros de datos y la nube de forma segura, optimizando el rendimiento de aplicaciones y reduciendo costos operativos. Además, integra funciones de red, seguridad y optimización WAN en una sola plataforma, facilitando la gestión centralizada y el acceso eficiente a entornos cloud e híbridos.',
        image: '/img/productos/silver-peak.png',
        categoriaSlug: 'aceleracion-wan',
        externalUrl: 'https://www.hpe.com/mx/es/solutions/silver-peak.html'
    },
    {
        id: 12,
        name: 'VMware',
