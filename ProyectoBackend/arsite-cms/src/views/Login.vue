		...
		<div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100">
			<div class="px-6 sm:px-8 py-8 sm:py-10">
				...
				<div class="text-center mb-6">
					...
					<p class="text-sm text-gray-600 mt-12 pb-1">Inicia sesión para continuar</p>
				</div>
				...
				<Transition name="slide-down">
					<div
						v-if="logoutReason === 'inactivity'"
						class="mb-6 rounded-lg bg-amber-50 border border-amber-200 p-3 flex items-center shadow-sm"
					>
						<span class="text-sm text-amber-800 ml-1 flex-1 break-words pr-2"
							>Tu sesión se cerró por inactividad.</span
						>

						<button
							type="button"
							@click="clearLogoutReason"
				...
				<form @submit.prevent="handleLogin" class="space-y-6">
					<div>
						...
						<input
							...
							class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors text-gray-900 text-base"
						/>
					</div>
					...
					<div>
						<label
							for="password"
							class="block text-sm font-medium text-gray-700 mb-2 pt-2"
							>Contraseña</label
						>
						<div class="relative">
							<input
								...
								class="block w-full px-4 py-3 pr-12 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-colors text-gray-900 text-base"
							/>
							<button
								type="button"
					...
					<div class="flex items-center justify-between mt-12 pt-1">
						<div class="flex items-center">
							<input
								...
								class="h-4 w-4 text-indigo-600 border-gray-300 rounded cursor-pointer flex-shrink-0"
							/>
							<label
								for="remember"
					...
					<div class="mt-12 pt-2">
						<button
							...
							class="btn-login w-full py-3 px-4 text-white font-bold rounded-lg shadow-sm transition-all flex items-center justify-center gap-2"
							:class="[
...
/* Animación Shake */
.shake-animation {
	/* Usar !important para asegurar que el rojo le gane al indigo de Tailwind */
